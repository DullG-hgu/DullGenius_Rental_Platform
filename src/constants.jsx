...
2. 대여
  ...
  2.2 대여의 기간.
    ...
    2. 단체 대여
      ...
      그러나, 단체 대여가 부원들이 보드게임을 대여할 수 있는 권리를 침해할 수 있고, 보드게임 파손의 염려가 있기에, 임원단은 다음과 같은 정보를 요청할 수 있다.
      1. 행사의 개요
      2. 일정 계획
      3. 예상 보드게임 플레이어 
      단체 대여의 경우, 대여와 반납의 기간을 명확하게 공지하여, 부원의 불만을 최소화하여야 한다.
...
5. 벌금
  부원과 외부인 모두 보드게임 연체 및 시설 파손 등 기타 사유에 대하여 벌금을 부과할 수 있다.
    1. 단기 대여의 연체
    외부인의 경우에는 연체시 대여비의 50%가 누산된다. 금액 누산은 3일마다 반복된다. 이 금액은 반납 시 낼 의무가 있다.
        예를 들어, 3/1일에 빌린 게임은 3/2일 24시 이전에 반납하면 누산이 없고, 3/3일 0시부터 추가 금액이 붙는다. 3일이 지난 3/6일에도 마찬가지로 금액이 누산된다.
    2. 부원의 연체
    부원의 경우에는 내부 포인트 제도를 통해 반납 연체에 대한 패널티를 진다. 한 학기 동안 3번의 연체 시, 다음 학기까지 대여가 불가능하다.
    3. 기타 시설 파손 등
    ...
    5. 벌금의 항소 및 처리
    벌금에 대한 판단에 불만이 있을 경우 운영진에게 재심의를 요청할 수 있다. 
    벌금 연체의 사유가 정당하다고 판단될 경우, 운영진은 벌금을 면제할 수 있다.

6. 도난
    1. 도난
    대여자가 벌금을 내고자 하지 않거나 반납을 하지 않는 경우를 도난 상황으로 칭한다.
    운영진은 대여자의 신상을 공개할 수 있다.
    2. 
